...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
  ...
  /* USER CODE BEGIN I2C2_MspInit 1 */
    ...
    /* Wait for 100 ms until bus is stable */
    HAL_Delay(100);
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* hqspi)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PA6     ------> QUADSPI_BK1_IO3
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_11|GPIO_PIN_0|GPIO_PIN_1);

    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_7|GPIO_PIN_3|GPIO_PIN_6);
...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_9|GPIO_PIN_1|GPIO_PIN_0|GPIO_PIN_5
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_4|GPIO_PIN_1|GPIO_PIN_5
                          ...
                          |GPIO_PIN_12|GPIO_PIN_11|GPIO_PIN_13|GPIO_PIN_9
                          |GPIO_PIN_8;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOG, GPIO_PIN_9|GPIO_PIN_1|GPIO_PIN_0|GPIO_PIN_5
                          |GPIO_PIN_4|GPIO_PIN_3|GPIO_PIN_2);
